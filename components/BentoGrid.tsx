...
export default function BentoGrid() {
  return (
    <motion.div
      ...
      whileInView="actief"
      viewport={inView}
      className="grid gap-3 md:grid-cols-6 md:gap-4"
    >
      <motion.div variants={rijst} className="md:col-span-4">
      ...
      <motion.div variants={rijst} className="md:col-span-2">
      ...
      <motion.div variants={rijst} className="md:col-span-6">
        <GlassCard stil className="py-7">
          <h3 className="px-7 text-xs font-medium uppercase tracking-[0.18em] text-ink/45 md:px-8">
